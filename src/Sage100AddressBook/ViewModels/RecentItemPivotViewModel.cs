...
{
    /// <summary>
    /// View model for the recently purchased items pivot item.
    /// </summary>
    public class RecentItemPivotViewModel : BindableBase
    {
        ...
        /// Constructor.
        /// </summary>
        public RecentItemPivotViewModel(ViewModelLoading owner)
        {
        ...
        public async Task Load()
        {
            ...
            }).ContinueWith(async (t) =>
            {
                await dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
                {
                    try
                    {
                        if (t.IsCompleted) _items.Set(t.Result);
