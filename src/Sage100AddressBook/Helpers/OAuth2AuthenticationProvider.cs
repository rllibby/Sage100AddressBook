...
namespace Sage100AddressBook.Helpers
{
    ...
    public class OAuth2AuthenticationProvider : IAuthenticationProvider
    {
        ...
        {
            var code = await GetAuthorizationCodeAsync(_returnUrl);
        ...
        private async Task<string> GetAuthorizationCodeAsync(string returnUrl = null)
        {
            ...
            var result = await WebAuthenticationBroker.AuthenticateAsync(WebAuthenticationOptions.None, requestUri, new Uri(_returnUrl));
            ...
            { 
                ...
                {   
                    ...
                    if (responseValues != null)
                    {
                        ...
                        ApplicationData.Current.LocalSettings.Values[RefreshToken] = _refreshToken;
        ...
        public OAuth2AuthenticationProvider(string clientId, string returnUrl, string[] scopes, IHttpProvider httpProvider = null)
        {
            ...
            _refreshToken = (string)ApplicationData.Current.LocalSettings.Values[RefreshToken];
        ...
        public async Task AuthenticateAsync()
        {
            ...
            if (!string.IsNullOrEmpty(_refreshToken))
            {
                ...
                {
                    ApplicationData.Current.LocalSettings.Values[RefreshToken] = _refreshToken = null;
                }
            }
